...
const EditCovidForm = () => {
  ...
  useEffect(() => {
    if (params && params.id) dispatch(getCovidSurveyById(parseInt(params.id)))
  }, [dispatch, params])
      ...
      dispatch(updateCovidSurvey(userCovidSurvey.id, getValues())).then(
        (data) => {
          if (data) {
            ...
            notifySuccess({
              header: 'Success',
              message: 'Covid survey has been updated.',
            })
  ...
  return (
    <Card>
      {userCovidSurvey ? (
                    ...
                    <Controller
                      ...
                      render={({ field }) => (
                        <Select
                          ...
                          options={
                            symptomsGroup &&
                            symptomsGroup.map(renderSymptomsOption)
                          }
                        />
        ...
        <Content className="p-15 edit-user-survey-notfound">
          <i>User Covid Details Not Found!</i>
        </Content>
      )}
    </Card>
  )
...
export default EditCovidForm as React.FC
